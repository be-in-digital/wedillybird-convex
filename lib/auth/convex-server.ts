...
const rawConvexApi = {
  ...
  autoNumberSeats: api.seating.autoNumberSeats,
  setSeatingPublication: api.seating.setSeatingPublication,
  getSeatPassByToken: api.seatingGuest.getSeatPassByToken,
  broadcastSeatPasses: api.seatingActions.broadcastSeatPasses,
  ...
  adminUserDeletionPreview: api.admin.userDeletionPreview,
